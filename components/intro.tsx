    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          <motion.span
            className="absolute bottom-0 left-16 text-4xl"
            initial={{ opacity: 0, scale: 0 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{
              type: "spring",
      ...
      >
        <span className="font-bold">Hello, I'm Albin.</span> I'm a{" "} 
        <span>self-taught</span>{" "}
        <span className="font-bold">front-end developer</span> I enjoy building <span className="italic">sites & apps</span>. My focus is{" "}
      ...
      >
        ...
        <a
          ...
          href="https://github.com/Albin9699"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
